...
export const JOBLIST_DATA = [
  {
    id: 1,
    title: 'Software Engineer',
    salary: '$120K/year',
    source: ['Google', 'Remote', 'Posted 2 days ago'],
    job_type: 'Full Time',
    company: [
      'Google is a technology company that specializes in internet-realted services and products',
    ],
    job_details: {
      description:
        'Join our engineering team to develop innovative solutions and contribute to Googles core products.',
      requirements: [
  ...
  },
  {
    ...
    salary: '$150K/year',
    source: ['Amazon', 'Hybrid', 'Posted 5 days ago'],
    job_type: 'Full Time',
    company: [
      'Google is a technology company that specializes in internet-realted services and products',
    ],
  ...
  },
  {
    ...
    title: 'UX Designer',
    salary: '$110K/year',
    source: ['Apple', 'Onsite', 'Posted 1 days ago'],
    job_type: 'Full Time',
    company: [
      'Google is a technology company that specializes in internet-realted services and products',
    ],
  ...
  },
  {
    ...
    title: 'Data Analyst',
    salary: '$130K/year',
    source: ['Microsoft', 'Remote', 'Posted 3 days ago'],
    job_type: 'Full Time',
    company: [
      'Google is a technology company that specializes in internet-realted services and products',
    ],
  ...
  },
  {
    ...
    salary: '$140K/year',
    source: ['Meta', 'Hybrid', 'Posted 1 day ago'],
    job_type: 'Full Time',
    company: [
      'Google is a technology company that specializes in internet-realted services and products',
    ],
  ...
  },
  {
    ...
    salary: '$125K/year',
    source: ['Netflix', 'Onsite', 'Posted 4 day ago'],
    job_type: 'Full Time',
    company: [
      'Google is a technology company that specializes in internet-realted services and products',
    ],
