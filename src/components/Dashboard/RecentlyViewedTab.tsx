              ...
              <div className="mt-2 p-2 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                ...
                <div className="flex gap-2 mt-2">
                  <button
                    ...
                    className="flex-1 px-2 py-1 bg-gradient-to-r from-[#10b981] to-[#047857] text-white rounded-[10px] text-xs shadow-[0_4px_15px_rgba(16,185,129,0.3)] hover:shadow-[0_6px_20px_rgba(16,185,129,0.4)] hover:-translate-y-0.5 transition-all duration-300"
                  >
                    Save
                  </button>
                  <button
