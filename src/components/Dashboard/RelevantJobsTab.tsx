    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          disabled={refreshing}
          className="inline-flex items-center px-4 py-2 bg-primary-10 text-white text-sm font-medium rounded-md hover:bg-primary-15 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-10 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {refreshing ? (
      ...
      {jobs.length === 0 ? (
        <div className="text-center py-12">
          ...
          <button
            ...
            className="inline-flex items-center px-4 py-2 bg-primary-10 text-white text-sm font-medium rounded-md hover:bg-primary-15 transition-colors"
          >
            Update Preferences
          </button>
        </div>
