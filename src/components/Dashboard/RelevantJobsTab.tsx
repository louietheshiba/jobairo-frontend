    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          disabled={refreshing}
          className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-[#00d4aa] to-[#00b894] text-white text-sm font-medium rounded-[10px] shadow-[0_4px_15px_rgba(0,212,170,0.3)] hover:shadow-[0_6px_20px_rgba(0,212,170,0.4)] hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#00d4aa] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {refreshing ? (
      ...
      {jobs.length === 0 ? (
        <div className="text-center py-12">
          ...
          <button
            ...
            className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-[#00d4aa] to-[#00b894] text-white text-sm font-medium rounded-[10px] shadow-[0_4px_15px_rgba(0,212,170,0.3)] hover:shadow-[0_6px_20px_rgba(0,212,170,0.4)] hover:-translate-y-1 transition-all duration-300"
          >
            Update Preferences
          </button>
        </div>
