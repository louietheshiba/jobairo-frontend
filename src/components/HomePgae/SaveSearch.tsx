  ...
  return (
    <div className="flex flex-col gap-2.5 rounded-md bg-themeGray-5 p-[15px] dark:bg-dark-20 sm:gap-[14px] sm:px-7 sm:pb-4 sm:pt-6">
      <div className="flex flex-col items-center gap-2.5 lg:flex-row lg:gap-5">
        <div className="grid h-full w-full gap-2.5 lg:grid-cols-3 lg:gap-5">
        ...
        <Button className="flex w-full items-center justify-center !border-primary-10 !bg-primary-10 !text-white duration-300 hover:!border-primary-15 hover:!bg-primary-15 md:max-w-[140px]">
          Search
        </Button>
      </div>
