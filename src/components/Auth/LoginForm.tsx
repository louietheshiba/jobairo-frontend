      ...
      <form onSubmit={handleEmailLogin} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-[#00d4aa] focus:border-[#00d4aa] dark:bg-dark-25 dark:border-gray-600 dark:text-white"
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="text-sm text-[#00d4aa] hover:text-[#00b894] dark:text-white"
          >
            Forgot password?
          </button>
        </div>
      ...
      <div className="mt-6 text-center">
        <span className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <button
            ...
            className="text-[#00d4aa] hover:text-[#00b894] dark:text-blue-400 font-medium"
          >
            Sign up
          </button>
        </span>
